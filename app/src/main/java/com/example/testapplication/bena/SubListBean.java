...
public class SubListBean extends BaseBean{
    private List<SubsData> data;


    public SubListBean(int code, String message, List<SubsData> data) {
        super(code, message);
        this.data = data;
    }

    public List<SubsData> getData() {
        return data;
    }

    public void setData(List<SubsData> data) {
        this.data = data;
    }
